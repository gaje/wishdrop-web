...
export default function AddFamilyMemberPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await api.family.createMember(data)
      router.push('/family')
    } catch (err) {
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">Add Family Member</h1>
              <p className="text-slate-500">Create a profile for someone you love</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-slate-900">Add More Details</span>
