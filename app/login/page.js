...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-slate-100 flex items-start justify-center px-4 pt-8 sm:pt-16 pb-12 relative overflow-hidden">
