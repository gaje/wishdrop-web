...
// Color Palette (aligned with Wishdrop logo — matches mobile design.js)
export const COLORS = {
  // Primary (Cyan — extracted from Wishdrop logo)
  primary: '#00CAFF', // logo cyan
  primaryLight: '#33D6FF', // lighter cyan
  primaryDark: '#00A8D4', // darker cyan
  primaryVeryLight: '#E6F9FF', // very light cyan
  ...
  gradientHero: 'linear-gradient(135deg, #00CAFF 0%, #00A8D4 100%)',
  gradientSecondary: 'linear-gradient(135deg, #00CAFF 0%, #00B4E6 50%, #00A8D4 100%)',
  gradientButton: 'linear-gradient(135deg, #00CAFF 0%, #00A8D4 100%)',
  gradientBgSubtle: 'linear-gradient(135deg, #E6F9FF 0%, #ecfeff 50%, #eff6ff 100%)',
}
...
export const SHADOWS = {
  ...
  colored: '0 8px 20px rgba(0, 202, 255, 0.3)', // primary color shadow
}
...
export const TW = {
  ...
  // Buttons
  btnPrimary: 'bg-gradient-to-r from-cyan-500 to-cyan-500 text-white font-semibold py-3 px-6 rounded-full hover:shadow-lg hover:-translate-y-0.5 transition-all',
